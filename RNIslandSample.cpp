// RNIslandSample.cpp : Defines the entry point for the application.
//

#include "pch.h"
#include "RNIslandSample.h"
...
// Global Variables:
constexpr PCWSTR windowTitle = L"RNIslandSample";
constexpr PCWSTR mainComponentName = L"RNIslandSample";
